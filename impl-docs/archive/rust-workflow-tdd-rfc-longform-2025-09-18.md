...
NOTE: Archived longform snapshot. Canonical entrypoint is `impl-docs/rust-workflow-tdd-rfc.md`.
...
- **Related ADRs:**
  - `adrs/adr-0001-invocation-abi-and-metadata.md`
  - `adrs/adr-0002-control-surfaces-0-1-scope.md`
  - `adrs/adr-0003-workers-native-constraints-and-spill.md`
  - `adrs/adr-0004-retry-ownership.md`
  - `adrs/adr-0005-determinism-claims-policy.md`
